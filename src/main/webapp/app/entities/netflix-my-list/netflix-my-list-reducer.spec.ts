...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NETFLIXMYLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_NETFLIXMYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NETFLIXMYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NETFLIXMYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NETFLIXMYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NETFLIXMYLIST actions', async () => {
      const expectedActions = [
        {
